...
/*   Updated: 2026/01/27 17:51:00 by eduaserr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../inc/cub3d.h"

static int	is_playable(char c)
{
	return (c == '0' || c == 'N' || c == 'S' || c == 'E' || c == 'W');
}

static int	is_nonplayable(char c)
{
	return (ft_isspace(c));
}
...
static int	check_tiles(char **map, int y, int x, int len)
{
	if (y == 0 || y == len - 1)
